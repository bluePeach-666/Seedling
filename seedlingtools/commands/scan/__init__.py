...
def setup_scan_parser(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("-e", "--exclude", nargs="+", default=None, help="Files/directories to exclude")
    parser.add_argument("--include", nargs="+", default=None, help="Only include files/directories matching patterns")
    parser.add_argument("-t", "--type", type=str, default=None, help="Filter by file type")
    parser.add_argument("--nohidden", dest="no_hidden", action="store_true", default=None, help="Do not scan hidden files")
    parser.add_argument("--text", dest="text_only", action="store_true", default=None, help="Only scan text files")
    parser.add_argument("-v", "--verbose", action="store_true", help="Enable debug logging")
    parser.add_argument("-q", "--quiet", action="store_true", default=None, help="Only show errors")
    ...
    parser.add_argument("--regex", action="store_true", default=None, help="Treat -f/-g pattern as regular expression")
    ...
    grep_group.add_argument("-i", "--ignore-case", action="store_true", default=None, help="Case-insensitive search")
...
def handle_scan(args: argparse.Namespace) -> None:
    ...
    config: ScanConfig = config_manager.build_scan_config(args)
    ...
    try:
        ...
        excludes: List[str] = expand_scan_excludes(config.excludes)
        is_explicit_ignore: bool = False
        for raw_input in config.excludes:
        ...
        file_type_arg: Optional[str] = config.file_type
        ...
        final_show_hidden: bool = config.show_hidden
        ...
        text_only_arg: bool = config.text_only
        if grep_pattern is not None:
            text_only_arg = True
